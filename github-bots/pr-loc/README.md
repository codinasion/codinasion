...
1. Install the [PR LOC BOT](https://github.com/apps/pr-loc) on your GitHub repository.

Now, whenever you create a Pull Request, the BOT will add a label to your Pull Request with the size of the Pull Request in terms of the number of lines of code changed.

| Label Name | LOC Range |
| ---------- | --------- |
| `XS`       | 0-9       |
| `S`        | 10-29     |
| `M`        | 30-99     |
...
![PR LOC BOT Preview](https://raw.githubusercontent.com/codinasion/codinasion/master/assets/preview/pr-loc-bot.png)
