...
pnpm add @codinasion/pascal-case-string

# or, if you're using npm
npm install @codinasion/pascal-case-string

# or, if you're using yarn
yarn add @codinasion/pascal-case-string
```
...
```javascript
import { PascalCaseStringToConstantCaseString } from "@codinasion/pascal-case-string";
