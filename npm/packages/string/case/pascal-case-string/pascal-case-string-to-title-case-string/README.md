# `@codinasion/pascal-case-string-to-title-case-string`
...
pnpm add @codinasion/pascal-case-string-to-title-case-string

# or, if you're using npm
npm install @codinasion/pascal-case-string-to-title-case-string

# or, if you're using yarn
yarn add @codinasion/pascal-case-string-to-title-case-string
```
...
```javascript
import { PascalCaseStringToTitleCaseString } from "@codinasion/pascal-case-string-to-title-case-string";
