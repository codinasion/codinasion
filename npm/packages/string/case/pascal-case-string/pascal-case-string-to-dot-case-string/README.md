# `@codinasion/pascal-case-string-to-dot-case-string`
...
pnpm add @codinasion/pascal-case-string-to-dot-case-string

# or, if you're using npm
npm install @codinasion/pascal-case-string-to-dot-case-string

# or, if you're using yarn
yarn add @codinasion/pascal-case-string-to-dot-case-string
```
