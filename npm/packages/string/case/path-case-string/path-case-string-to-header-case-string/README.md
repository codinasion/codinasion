# `@codinasion/path-case-string-to-header-case-string`
...
pnpm add @codinasion/path-case-string-to-header-case-string

# or, if you're using npm
npm install @codinasion/path-case-string-to-header-case-string

# or, if you're using yarn
yarn add @codinasion/path-case-string-to-header-case-string
```
...
```javascript
import { PathCaseStringToHeaderCaseString } from "@codinasion/path-case-string-to-header-case-string";
