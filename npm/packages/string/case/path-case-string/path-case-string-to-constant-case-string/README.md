# `@codinasion/path-case-string-to-constant-case-string`
...
pnpm add @codinasion/path-case-string-to-constant-case-string

# or, if you're using npm
npm install @codinasion/path-case-string-to-constant-case-string

# or, if you're using yarn
yarn add @codinasion/path-case-string-to-constant-case-string
```
