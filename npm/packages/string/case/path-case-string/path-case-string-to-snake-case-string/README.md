# `@codinasion/path-case-string-to-snake-case-string`
...
pnpm add @codinasion/path-case-string-to-snake-case-string

# or, if you're using npm
npm install @codinasion/path-case-string-to-snake-case-string

# or, if you're using yarn
yarn add @codinasion/path-case-string-to-snake-case-string
```
...
```javascript
import { PathCaseStringToSnakeCaseString } from "@codinasion/path-case-string-to-snake-case-string";
