# `@codinasion/path-case-string-to-title-case-string`
...
pnpm add @codinasion/path-case-string-to-title-case-string

# or, if you're using npm
npm install @codinasion/path-case-string-to-title-case-string

# or, if you're using yarn
yarn add @codinasion/path-case-string-to-title-case-string
```
...
```javascript
import { PathCaseStringToTitleCaseString } from "@codinasion/path-case-string-to-title-case-string";
