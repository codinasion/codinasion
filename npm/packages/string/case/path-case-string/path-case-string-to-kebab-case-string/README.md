# `@codinasion/path-case-string-to-kebab-case-string`
...
pnpm add @codinasion/path-case-string-to-kebab-case-string

# or, if you're using npm
npm install @codinasion/path-case-string-to-kebab-case-string

# or, if you're using yarn
yarn add @codinasion/path-case-string-to-kebab-case-string
```
