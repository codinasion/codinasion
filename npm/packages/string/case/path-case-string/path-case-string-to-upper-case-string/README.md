# `@codinasion/path-case-string-to-upper-case-string`
...
pnpm add @codinasion/path-case-string-to-upper-case-string

# or, if you're using npm
npm install @codinasion/path-case-string-to-upper-case-string

# or, if you're using yarn
yarn add @codinasion/path-case-string-to-upper-case-string
```
