# `@codinasion/header-case-string-to-dot-case-string`
...
pnpm add @codinasion/header-case-string-to-dot-case-string

# or, if you're using npm
npm install @codinasion/header-case-string-to-dot-case-string

# or, if you're using yarn
yarn add @codinasion/header-case-string-to-dot-case-string
```
...
```javascript
import { HeaderCaseStringToDotCaseString } from "@codinasion/header-case-string-to-dot-case-string";
