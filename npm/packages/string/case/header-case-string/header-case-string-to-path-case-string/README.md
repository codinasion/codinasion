# `@codinasion/header-case-string-to-path-case-string`
...
pnpm add @codinasion/header-case-string-to-path-case-string

# or, if you're using npm
npm install @codinasion/header-case-string-to-path-case-string

# or, if you're using yarn
yarn add @codinasion/header-case-string-to-path-case-string
```
