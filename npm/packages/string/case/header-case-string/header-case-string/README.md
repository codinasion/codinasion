...
pnpm add @codinasion/header-case-string

# or, if you're using npm
npm install @codinasion/header-case-string

# or, if you're using yarn
yarn add @codinasion/header-case-string
```
...
```javascript
import { HeaderCaseStringToCamelCaseString } from "@codinasion/header-case-string";
