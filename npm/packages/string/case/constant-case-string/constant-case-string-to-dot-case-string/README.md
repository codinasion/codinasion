# `@codinasion/constant-case-string-to-dot-case-string`
...
pnpm add @codinasion/constant-case-string-to-dot-case-string

# or, if you're using npm
npm install @codinasion/constant-case-string-to-dot-case-string

# or, if you're using yarn
yarn add @codinasion/constant-case-string-to-dot-case-string
```
...
```javascript
import { ConstantCaseStringToDotCaseString } from "@codinasion/constant-case-string-to-dot-case-string";
