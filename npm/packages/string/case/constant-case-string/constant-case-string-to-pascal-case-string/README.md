# `@codinasion/constant-case-string-to-pascal-case-string`
...
pnpm add @codinasion/constant-case-string-to-pascal-case-string

# or, if you're using npm
npm install @codinasion/constant-case-string-to-pascal-case-string

# or, if you're using yarn
yarn add @codinasion/constant-case-string-to-pascal-case-string
```
...
```javascript
import { ConstantCaseStringToPascalCaseString } from "@codinasion/constant-case-string-to-pascal-case-string";
