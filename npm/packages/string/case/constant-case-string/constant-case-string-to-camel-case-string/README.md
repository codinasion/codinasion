...
pnpm add @codinasion/constant-case-string-to-camel-case-string

# or, if you're using npm
npm install @codinasion/constant-case-string-to-camel-case-string

# or, if you're using yarn
yarn add @codinasion/constant-case-string-to-camel-case-string
```
