# `@codinasion/constant-case-string-to-upper-case-string`
...
pnpm add @codinasion/constant-case-string-to-upper-case-string

# or, if you're using npm
npm install @codinasion/constant-case-string-to-upper-case-string

# or, if you're using yarn
yarn add @codinasion/constant-case-string-to-upper-case-string
```
