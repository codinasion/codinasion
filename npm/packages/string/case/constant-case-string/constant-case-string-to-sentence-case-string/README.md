# `@codinasion/constant-case-string-to-sentence-case-string`
...
```javascript
import { ConstantCaseStringToSentenceCaseString } from "@codinasion/constant-case-string-to-sentence-case-string";
