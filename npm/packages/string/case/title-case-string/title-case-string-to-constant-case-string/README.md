...
pnpm add @codinasion/title-case-string-to-constant-case-string

# or, if you're using npm
npm install @codinasion/title-case-string-to-constant-case-string

# or, if you're using yarn
yarn add @codinasion/title-case-string-to-constant-case-string
```
...
```javascript
import { TitleCaseStringToConstantCaseString } from "@codinasion/title-case-string-to-constant-case-string";
