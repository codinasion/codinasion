# `@codinasion/title-case-string-to-sentence-case-string`
...
pnpm add @codinasion/title-case-string-to-sentence-case-string

# or, if you're using npm
npm install @codinasion/title-case-string-to-sentence-case-string

# or, if you're using yarn
yarn add @codinasion/title-case-string-to-sentence-case-string
```
