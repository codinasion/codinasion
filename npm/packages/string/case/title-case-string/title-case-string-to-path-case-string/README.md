# `@codinasion/title-case-string-to-path-case-string`
...
pnpm add @codinasion/title-case-string-to-path-case-string

# or, if you're using npm
npm install @codinasion/title-case-string-to-path-case-string

# or, if you're using yarn
yarn add @codinasion/title-case-string-to-path-case-string
```
