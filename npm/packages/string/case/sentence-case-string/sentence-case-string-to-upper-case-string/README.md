# `@codinasion/sentence-case-string-to-upper-case-string`

Convert a sentence case string to an upper case string.
...
pnpm add @codinasion/sentence-case-string-to-upper-case-string

# or, if you're using npm
npm install @codinasion/sentence-case-string-to-upper-case-string

# or, if you're using yarn
yarn add @codinasion/sentence-case-string-to-upper-case-string
```
