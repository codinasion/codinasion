# `@codinasion/sentence-case-string-to-lower-case-string`

Convert a sentence case string to a lower case string.
...
pnpm add @codinasion/sentence-case-string-to-lower-case-string

# or, if you're using npm
npm install @codinasion/sentence-case-string-to-lower-case-string

# or, if you're using yarn
yarn add @codinasion/sentence-case-string-to-lower-case-string
```
...
```javascript
import { SentenceCaseStringToLowerCaseString } from "@codinasion/sentence-case-string-to-lower-case-string";
