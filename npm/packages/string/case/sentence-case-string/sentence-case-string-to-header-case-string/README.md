# `@codinasion/sentence-case-string-to-header-case-string`
...
pnpm add @codinasion/sentence-case-string-to-header-case-string

# or, if you're using npm
npm install @codinasion/sentence-case-string-to-header-case-string

# or, if you're using yarn
yarn add @codinasion/sentence-case-string-to-header-case-string
```
...
```javascript
import { SentenceCaseStringToHeaderCaseString } from "@codinasion/sentence-case-string-to-header-case-string";
