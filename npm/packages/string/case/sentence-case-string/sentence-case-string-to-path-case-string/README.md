...
Convert a sentence case string to a path case string.
...
pnpm add @codinasion/sentence-case-string-to-path-case-string

# or, if you're using npm
npm install @codinasion/sentence-case-string-to-path-case-string

# or, if you're using yarn
yarn add @codinasion/sentence-case-string-to-path-case-string
```
