# `@codinasion/camel-case-string-to-kebab-case-string`
...
pnpm add @codinasion/camel-case-string-to-kebab-case-string

# or, if you're using npm
npm install @codinasion/camel-case-string-to-kebab-case-string

# or, if you're using yarn
yarn add @codinasion/camel-case-string-to-kebab-case-string
```
...
```javascript
import { CamelCaseStringToKebabCaseString } from "@codinasion/camel-case-string-to-kebab-case-string";
