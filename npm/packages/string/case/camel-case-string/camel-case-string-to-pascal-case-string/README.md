# `@codinasion/camel-case-string-to-pascal-case-string`
...
pnpm add @codinasion/camel-case-string-to-pascal-case-string

# or, if you're using npm
npm install @codinasion/camel-case-string-to-pascal-case-string

# or, if you're using yarn
yarn add @codinasion/camel-case-string-to-pascal-case-string
```
