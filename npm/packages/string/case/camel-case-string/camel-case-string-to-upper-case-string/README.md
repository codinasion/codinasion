# `@codinasion/camel-case-string-to-upper-case-string`
...
pnpm add @codinasion/camel-case-string-to-upper-case-string

# or, if you're using npm
npm install @codinasion/camel-case-string-to-upper-case-string

# or, if you're using yarn
yarn add @codinasion/camel-case-string-to-upper-case-string
```
...
```javascript
import { CamelCaseStringToUpperCaseString } from "@codinasion/camel-case-string-to-upper-case-string";
