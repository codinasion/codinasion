# `@codinasion/camel-case-string-to-dot-case-string`
...
pnpm add @codinasion/camel-case-string-to-dot-case-string

# or, if you're using npm
npm install @codinasion/camel-case-string-to-dot-case-string

# or, if you're using yarn
yarn add @codinasion/camel-case-string-to-dot-case-string
```
...
```javascript
import { CamelCaseStringToDotCaseString } from "@codinasion/camel-case-string-to-dot-case-string";
