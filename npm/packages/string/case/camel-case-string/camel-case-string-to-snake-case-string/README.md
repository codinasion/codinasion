# `@codinasion/camel-case-string-to-snake-case-string`
...
pnpm add @codinasion/camel-case-string-to-snake-case-string

# or, if you're using npm
npm install @codinasion/camel-case-string-to-snake-case-string

# or, if you're using yarn
yarn add @codinasion/camel-case-string-to-snake-case-string
```
