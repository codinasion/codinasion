# `@codinasion/lower-case-string-to-kebab-case-string`
...
pnpm add @codinasion/lower-case-string-to-kebab-case-string

# or, if you're using npm
npm install @codinasion/lower-case-string-to-kebab-case-string

# or, if you're using yarn
yarn add @codinasion/lower-case-string-to-kebab-case-string
```
...
```javascript
import { LowerCaseStringToKebabCaseString } from "@codinasion/lower-case-string-to-kebab-case-string";
