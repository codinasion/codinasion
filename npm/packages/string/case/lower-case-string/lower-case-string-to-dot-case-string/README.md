# `@codinasion/lower-case-string-to-dot-case-string`
...
pnpm add @codinasion/lower-case-string-to-dot-case-string

# or, if you're using npm
npm install @codinasion/lower-case-string-to-dot-case-string

# or, if you're using yarn
yarn add @codinasion/lower-case-string-to-dot-case-string
```
