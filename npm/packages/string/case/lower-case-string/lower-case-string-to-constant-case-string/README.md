# `@codinasion/lower-case-string-to-constant-case-string`
...
pnpm add @codinasion/lower-case-string-to-constant-case-string

# or, if you're using npm
npm install @codinasion/lower-case-string-to-constant-case-string

# or, if you're using yarn
yarn add @codinasion/lower-case-string-to-constant-case-string
```
...
```javascript
import { LowerCaseStringToConstantCaseString } from "@codinasion/lower-case-string-to-constant-case-string";
