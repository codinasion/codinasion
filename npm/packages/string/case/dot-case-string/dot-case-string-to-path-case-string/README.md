# `@codinasion/dot-case-string-to-path-case-string`
...
pnpm add @codinasion/dot-case-string-to-path-case-string

# or, if you're using npm
npm install @codinasion/dot-case-string-to-path-case-string

# or, if you're using yarn
yarn add @codinasion/dot-case-string-to-path-case-string
```
