# `@codinasion/dot-case-string-to-snake-case-string`
...
pnpm add @codinasion/dot-case-string-to-snake-case-string

# or, if you're using npm
npm install @codinasion/dot-case-string-to-snake-case-string

# or, if you're using yarn
yarn add @codinasion/dot-case-string-to-snake-case-string
```
...
```javascript
import { DotCaseStringToSnakeCaseString } from "@codinasion/dot-case-string-to-snake-case-string";
