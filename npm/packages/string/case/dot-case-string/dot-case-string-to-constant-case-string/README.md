...
Converts a dot.case string to a CONSTANT_CASE string.
...
pnpm add @codinasion/dot-case-string-to-constant-case-string

# or, if you're using npm
npm install @codinasion/dot-case-string-to-constant-case-string

# or, if you're using yarn
yarn add @codinasion/dot-case-string-to-constant-case-string
```
...
```javascript
import { DotCaseStringToConstantCaseString } from "@codinasion/dot-case-string-to-constant-case-string";
