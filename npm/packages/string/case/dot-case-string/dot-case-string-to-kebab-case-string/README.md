# `@codinasion/dot-case-string-to-kebab-case-string`
...
pnpm add @codinasion/dot-case-string-to-kebab-case-string

# or, if you're using npm
npm install @codinasion/dot-case-string-to-kebab-case-string

# or, if you're using yarn
yarn add @codinasion/dot-case-string-to-kebab-case-string
```
