# `@codinasion/upper-case-string-to-snake-case-string`
...
pnpm add @codinasion/upper-case-string-to-snake-case-string

# or, if you're using npm
npm install @codinasion/upper-case-string-to-snake-case-string

# or, if you're using yarn
yarn add @codinasion/upper-case-string-to-snake-case-string
```
...
```javascript
import { UpperCaseStringToSnakeCaseString } from "@codinasion/upper-case-string-to-snake-case-string";
