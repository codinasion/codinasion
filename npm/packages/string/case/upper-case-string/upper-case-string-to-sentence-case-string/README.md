# `@codinasion/upper-case-string-to-sentence-case-string`
...
pnpm add @codinasion/upper-case-string-to-sentence-case-string

# or, if you're using npm
npm install @codinasion/upper-case-string-to-sentence-case-string

# or, if you're using yarn
yarn add @codinasion/upper-case-string-to-sentence-case-string
```
...
```javascript
import { UpperCaseStringToSentenceCaseString } from "@codinasion/upper-case-string-to-sentence-case-string";
