# `@codinasion/snake-case-string-to-header-case-string`
...
pnpm add @codinasion/snake-case-string-to-header-case-string

# or, if you're using npm
npm install @codinasion/snake-case-string-to-header-case-string

# or, if you're using yarn
yarn add @codinasion/snake-case-string-to-header-case-string
```
...
```javascript
import { SnakeCaseStringToHeaderCaseString } from "@codinasion/snake-case-string-to-header-case-string";
