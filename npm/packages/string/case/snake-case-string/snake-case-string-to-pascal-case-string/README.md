# `@codinasion/snake-case-string-to-pascal-case-string`
...
pnpm add @codinasion/snake-case-string-to-pascal-case-string

# or, if you're using npm
npm install @codinasion/snake-case-string-to-pascal-case-string

# or, if you're using yarn
yarn add @codinasion/snake-case-string-to-pascal-case-string
```
...
```javascript
import { SnakeCaseStringToPascalCaseString } from "@codinasion/snake-case-string-to-pascal-case-string";
