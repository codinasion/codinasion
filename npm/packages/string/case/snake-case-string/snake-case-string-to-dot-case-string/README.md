# `@codinasion/snake-case-string-to-dot-case-string`
...
pnpm add @codinasion/snake-case-string-to-dot-case-string

# or, if you're using npm
npm install @codinasion/snake-case-string-to-dot-case-string

# or, if you're using yarn
yarn add @codinasion/snake-case-string-to-dot-case-string
```
...
```javascript
import { SnakeCaseStringToDotCaseString } from "@codinasion/snake-case-string-to-dot-case-string";
