# `@codinasion/snake-case-string`

A collection of useful TypeScript functions and utilities for snake case string manipulation.
...
pnpm add @codinasion/snake-case-string

# or, if you're using npm
npm install @codinasion/snake-case-string

# or, if you're using yarn
yarn add @codinasion/snake-case-string
```
...
```javascript
import { SnakeCaseStringToDotCaseString } from "@codinasion/snake-case-string";
