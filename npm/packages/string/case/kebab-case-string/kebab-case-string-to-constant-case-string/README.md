# `@codinasion/kebab-case-string-to-constant-case-string`
...
```javascript
import { KebabCaseStringToConstantCaseString } from "@codinasion/kebab-case-string-to-constant-case-string";
