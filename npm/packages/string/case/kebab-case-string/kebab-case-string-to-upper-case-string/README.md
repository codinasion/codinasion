# `@codinasion/kebab-case-string-to-upper-case-string`
...
pnpm add @codinasion/kebab-case-string-to-upper-case-string

# or, if you're using npm
npm install @codinasion/kebab-case-string-to-upper-case-string

# or, if you're using yarn
yarn add @codinasion/kebab-case-string-to-upper-case-string
```
...
```javascript
import { KebabCaseStringToUpperCaseString } from "@codinasion/kebab-case-string-to-upper-case-string";
