# `@codinasion/kebab-case-string-to-pascal-case-string`
...
pnpm add @codinasion/kebab-case-string-to-pascal-case-string

# or, if you're using npm
npm install @codinasion/kebab-case-string-to-pascal-case-string

# or, if you're using yarn
yarn add @codinasion/kebab-case-string-to-pascal-case-string
```
...
```javascript
import { KebabCaseStringToPascalCaseString } from "@codinasion/kebab-case-string-to-pascal-case-string";
