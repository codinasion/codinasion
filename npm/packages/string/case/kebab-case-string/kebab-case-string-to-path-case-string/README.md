# `@codinasion/kebab-case-string-to-path-case-string`
...
pnpm add @codinasion/kebab-case-string-to-path-case-string

# or, if you're using npm
npm install @codinasion/kebab-case-string-to-path-case-string

# or, if you're using yarn
yarn add @codinasion/kebab-case-string-to-path-case-string
```
