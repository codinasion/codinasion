// Why this extra file ?
// In many cases, 'git commit' fails due to some reason. But, submit dsa program action still
...
export default async function submitDsaCommentClose(
  OWNER,
  REPO,
  TOKEN,
  ISSUE_NUMBER,
  ...
  const commentResponse = await fetch(
    `https://api.github.com/repos/${OWNER}/${REPO}/issues/${ISSUE_NUMBER}/comments`,
    {
      ...
      body: JSON.stringify({
        body: `DSA Program added successfully :tada:
